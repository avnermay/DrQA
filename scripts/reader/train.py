...
def set_defaults(args):
    ...
    if args.use_bert_embeddings:
        assert args.fix_embeddings, 'Must fix embeddings is using BERT embeddings.'
...
def main(args):
    ...
    train_exs = utils.load_data(args, args.train_file, skip_no_answer=True, trainset=True)
